...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2025-02-27 19:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dec726ea-d075-463c-bc41-1f30da61ea3c.git
$ cd dec726ea-d075-463c-bc41-1f30da61ea3c
```
